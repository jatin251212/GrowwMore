...
const NavLinks = () => {
    return (
        <>
            ...
            <HashLink className="px-2 font-extrabold text-gray-500 hover:text-blue-900" smooth to="/#services">
                Services
            </HashLink>
            <HashLink className="px-2 font-extrabold text-gray-500 hover:text-blue-900" to="/">
                Portfolio
            </HashLink>
